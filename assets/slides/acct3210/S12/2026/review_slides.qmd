...
2. Lecture Overviews (1-5). 
  - _This is a repeat of the information in Lecture 6._
3. Tax Terms to Know.
...
- Location: LTA (room assignments posted on Canvas) 
...
- Read each question carefully. These questions __come from the homework__ and
...
- Review the viable systems model (VSM) (basic idea of the 5 systems), the concept of
a resource bargain, and the location of the management accountant within the
VSM. 
