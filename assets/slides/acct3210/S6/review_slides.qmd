...
- __I will not ask you open-ended questions__, and the questions will come from
the homework (this means that the homework questions _are_ practice exam
questions.
...
- Review the viable systems model (VSM). Especially: the basic idea of the 5 systems, the concept of a resource bargin, and the location of the management accountant within the
VSM. 
