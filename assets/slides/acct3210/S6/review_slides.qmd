...
- Location: LTA (room assignments will be posted on Canvas) 
- We will arrange a separate room for students with conflicting exams and SEN
students. Please contact us if you have a conflict.
...
- The questions will come from the homework.
- The questions will be simplified so that they have clear answers, and fit the
  constraints of the exam (i.e. no calculators, no computers). 
- This means that the homework questions _are_ practice exam questions.
...
- Review the viable systems model (VSM). Especially: the basic idea of the 5
  systems, the concept of a resource bargain, and the location of the management
  accountant within the VSM. 
...
[_Please review this section of the slides for Lecture 1_](https://arthurhowardmorris.github.io/assets/slides/acct3210/S1/Lecture1handout.pdf)
...
3. Can you derive an incremental cost function from a total cost function?
...
- [__Lecture notes are posted here.__](https://arthurhowardmorris.github.io/resources/semesters/s2024/ACCTG3210.html#lecture-2-the-nature-of-costs)

Review the following:

- MC, IC, AC defined
- The Total Cost Functions from the Assignment
- Formula for AC
- Formula for MC
- Formula for IC
- [__Python Example__](https://arthurhowardmorris.github.io/assets/slides/acct3210/S2/Session2Example.ipynb)
- [__Excel Example__](https://arthurhowardmorris.github.io/assets/slides/acct3210/S2/Session2Example.xlsx)
...
There are four basic steps in common across the workflows that we discussed:
...
- [__Link to lecture notes here.__](https://arthurhowardmorris.github.io/resources/semesters/s2024/ACCTG3210.html#lecture-3-cost-estimation)

### Topics and examples:

- Data Workflow (Data Science)
- Data Workflow (Statistics)
- Data Workflow (Accountant)
- [__Python Example__](https://arthurhowardmorris.github.io/assets/slides/acct3210/S3/Lecture3Example_P2_P3.ipyng)
- [__Excel Example (Videos posted on Canvas).__](https://arthurhowardmorris.github.io/assets/slides/acct3210/S3/Lecture3Example_P2_P3.xlsx)
...
- [__Link to Lecture 4 Notes and Examples__](https://arthurhowardmorris.github.io/resources/semesters/s2024/ACCTG3210.html#lecture-4-non-linear-programs): Non-linear programs.
- [__Link to Lecture 5 Notes and Examples__](https://arthurhowardmorris.github.io/resources/semesters/s2024/ACCTG3210.html#lecture-5-linear-programs): Linear programs.

In these notes and examples, review the steps! Using your tool of choice (i.e. Excel or Python) can you:

- Step 1. Specify the Choice Variables
- Step 2. Specify the Objective Function
- Step 3. Specify the Constraints 
- Step 4. Solve 
    - Again, you do not have to do this step by hand.
...
- _Note: This is a very good question. The more specific detail you include, the better I can answer the question._
...
- This point is largely covered in the discussion of Session 1 and the VSM above.

## Economic significance of non-linearities. 

- This is a topic that comes up in our discussing of estimating cost curves. (See Session 2 discussion above)
...
![Non-linear cost curve, with relatively linear regions.](./F2-1.png)
...
- This is a source of non-linearity. Notice the effect of substituting the
constraint into the objective function in both lectures 4 and 5. 
